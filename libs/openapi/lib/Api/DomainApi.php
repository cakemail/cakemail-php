...
class DomainApi
{
     ...
     */
    public function patchDomains($brand_id, $patch_domains, $account_id = null)
    {
        list($response) = $this->patchDomainsWithHttpInfo($brand_id, $patch_domains, $account_id);
        return $response;
    }
     ...
     */
    public function patchDomainsWithHttpInfo($brand_id, $patch_domains, $account_id = null)
    {
        $request = $this->patchDomainsRequest($brand_id, $patch_domains, $account_id);
     ...
     */
    public function patchDomainsAsync($brand_id, $patch_domains, $account_id = null)
    {
        return $this->patchDomainsAsyncWithHttpInfo($brand_id, $patch_domains, $account_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function patchDomainsAsyncWithHttpInfo($brand_id, $patch_domains, $account_id = null)
    {
        $returnType = '\Cakemail\Lib\Model\PatchDomainsResponse';
        $request = $this->patchDomainsRequest($brand_id, $patch_domains, $account_id);
     ...
     */
    public function patchDomainsRequest($brand_id, $patch_domains, $account_id = null)
    {
        // verify the required parameter 'brand_id' is set
        if ($brand_id === null || (is_array($brand_id) && count($brand_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $brand_id when calling patchDomains'
            );
        }
        ...
        $resourcePath = '/brands/{brand_id}/domains/default';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     */
    public function showDomains($brand_id, $account_id = null)
    {
        list($response) = $this->showDomainsWithHttpInfo($brand_id, $account_id);
        return $response;
    }
     ...
     */
    public function showDomainsWithHttpInfo($brand_id, $account_id = null)
    {
        $request = $this->showDomainsRequest($brand_id, $account_id);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function showDomainsAsync($brand_id, $account_id = null)
    {
        return $this->showDomainsAsyncWithHttpInfo($brand_id, $account_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function showDomainsAsyncWithHttpInfo($brand_id, $account_id = null)
    {
        $returnType = '\Cakemail\Lib\Model\DomainsResponse';
        $request = $this->showDomainsRequest($brand_id, $account_id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function showDomainsRequest($brand_id, $account_id = null)
    {
        // verify the required parameter 'brand_id' is set
        if ($brand_id === null || (is_array($brand_id) && count($brand_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $brand_id when calling showDomains'
            );
        }
     ...
     */
    public function validateDomains($brand_id, $account_id = null)
    {
        list($response) = $this->validateDomainsWithHttpInfo($brand_id, $account_id);
        return $response;
    }
     ...
     */
    public function validateDomainsWithHttpInfo($brand_id, $account_id = null)
    {
        $request = $this->validateDomainsRequest($brand_id, $account_id);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function validateDomainsAsync($brand_id, $account_id = null)
    {
        return $this->validateDomainsAsyncWithHttpInfo($brand_id, $account_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function validateDomainsAsyncWithHttpInfo($brand_id, $account_id = null)
    {
        $returnType = '\Cakemail\Lib\Model\ValidateDomainsResponse';
        $request = $this->validateDomainsRequest($brand_id, $account_id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function validateDomainsRequest($brand_id, $account_id = null)
    {
        // verify the required parameter 'brand_id' is set
        if ($brand_id === null || (is_array($brand_id) && count($brand_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $brand_id when calling validateDomains'
            );
        }

        $resourcePath = '/brands/{brand_id}/domains/default/validate';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
