 ...
 */
class TemplateContent implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TemplateContent';
     ...
     * Gets type
     *
     * @return \Cakemail\Lib\Model\TemplateTypeEnum
     */
     ...
     * Sets type
     *
     * @param \Cakemail\Lib\Model\TemplateTypeEnum $type type
     *
     * @return self
     */
    ...
    public function setHtml($html)
    {
        ...
        if (!is_null($html) && (mb_strlen($html) < 1)) {
            throw new \InvalidArgumentException('invalid length for $html when calling TemplateContent., must be bigger than or equal to 1.');
        }
    ...
    public function setText($text)
    {
        ...
        if (!is_null($text) && (mb_strlen($text) < 1)) {
            throw new \InvalidArgumentException('invalid length for $text when calling TemplateContent., must be bigger than or equal to 1.');
        }
