...
class CampaignApi
{
     ...
     * @param  int $campaign_id campaign_id (required)
     * @param  int $account_id account_id (optional)
     * @param  int $revision_id revision_id (optional)
     *
     * @throws \Cakemail\Lib\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Cakemail\Lib\Model\CampaignResponse|\Cakemail\Lib\Model\HTTPBadRequestError|\Cakemail\Lib\Model\HTTPValidationError
     */
    public function getCampaign($campaign_id, $account_id = null, $revision_id = null)
    {
        list($response) = $this->getCampaignWithHttpInfo($campaign_id, $account_id, $revision_id);
        return $response;
    }
     ...
     * @param  int $campaign_id (required)
     * @param  int $account_id (optional)
     * @param  int $revision_id (optional)
     *
     * @throws \Cakemail\Lib\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     */
    public function getCampaignWithHttpInfo($campaign_id, $account_id = null, $revision_id = null)
    {
        $request = $this->getCampaignRequest($campaign_id, $account_id, $revision_id);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getCampaignAsync($campaign_id, $account_id = null, $revision_id = null)
    {
        return $this->getCampaignAsyncWithHttpInfo($campaign_id, $account_id, $revision_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getCampaignAsyncWithHttpInfo($campaign_id, $account_id = null, $revision_id = null)
    {
        $returnType = '\Cakemail\Lib\Model\CampaignResponse';
        $request = $this->getCampaignRequest($campaign_id, $account_id, $revision_id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getCampaignRequest($campaign_id, $account_id = null, $revision_id = null)
    {
        // verify the required parameter 'campaign_id' is set
        if ($campaign_id === null || (is_array($campaign_id) && count($campaign_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @throws \Cakemail\Lib\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Cakemail\Lib\Model\CampaignRevisionsResponse|\Cakemail\Lib\Model\HTTPBadRequestError|\Cakemail\Lib\Model\HTTPValidationError
     */
    public function getCampaignRevisions($campaign_id, $account_id = null, $page = 1, $per_page = 50, $with_count = false)
    {
        list($response) = $this->getCampaignRevisionsWithHttpInfo($campaign_id, $account_id, $page, $per_page, $with_count);
        return $response;
    }

    /**
     * Operation getCampaignRevisionsWithHttpInfo
     *
     * Show all campaign revisions
     *
     * @param  int $campaign_id (required)
     ...
     */
    public function getCampaignRevisionsWithHttpInfo($campaign_id, $account_id = null, $page = 1, $per_page = 50, $with_count = false)
    {
        $request = $this->getCampaignRevisionsRequest($campaign_id, $account_id, $page, $per_page, $with_count);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Cakemail\Lib\Model\CampaignRevisionsResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Cakemail\Lib\Model\CampaignRevisionsResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Cakemail\Lib\Model\CampaignRevisionsResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\Cakemail\Lib\Model\CampaignRevisionsResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Cakemail\Lib\Model\CampaignRevisionsResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation getCampaignRevisionsAsync
     *
     * Show all campaign revisions
     *
     * @param  int $campaign_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getCampaignRevisionsAsync($campaign_id, $account_id = null, $page = 1, $per_page = 50, $with_count = false)
    {
        return $this->getCampaignRevisionsAsyncWithHttpInfo($campaign_id, $account_id, $page, $per_page, $with_count)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getCampaignRevisionsAsyncWithHttpInfo
     *
     * Show all campaign revisions
     *
     * @param  int $campaign_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getCampaignRevisionsAsyncWithHttpInfo($campaign_id, $account_id = null, $page = 1, $per_page = 50, $with_count = false)
    {
        $returnType = '\Cakemail\Lib\Model\CampaignRevisionsResponse';
        $request = $this->getCampaignRevisionsRequest($campaign_id, $account_id, $page, $per_page, $with_count);
    ...
    /**
     * Create request for operation 'getCampaignRevisions'
     *
     * @param  int $campaign_id (required)
     * @param  int $account_id (optional)
     * @param  int $page (optional, default to 1)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getCampaignRevisionsRequest($campaign_id, $account_id = null, $page = 1, $per_page = 50, $with_count = false)
    {
        // verify the required parameter 'campaign_id' is set
        if ($campaign_id === null || (is_array($campaign_id) && count($campaign_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $campaign_id when calling getCampaignRevisions'
            );
        }

        $resourcePath = '/campaigns/{campaign_id}/revisions';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
