 ...
 * @link     https://openapi-generator.tech
 */
class UserConfirmation implements ModelInterface, ArrayAccess
{
    ...
    public function setPassword($password)
    {
        ...
        if ((mb_strlen($password) < 8)) {
            throw new \InvalidArgumentException('invalid length for $password when calling UserConfirmation., must be bigger than or equal to 8.');
        }
