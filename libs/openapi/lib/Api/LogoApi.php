...
class LogoApi
{
     ...
     * @return \Cakemail\Lib\Model\DeleteLogoResponse|\Cakemail\Lib\Model\HTTPBadRequestError|\Cakemail\Lib\Model\HTTPValidationError
     */
    public function deleteDefaultLogo($account_id = null)
    {
        list($response) = $this->deleteDefaultLogoWithHttpInfo($account_id);
        return $response;
    }

    /**
     * Operation deleteDefaultLogoWithHttpInfo
     *
     * Delete the default logo
     *
     ...
     */
    public function deleteDefaultLogoWithHttpInfo($account_id = null)
    {
        $request = $this->deleteDefaultLogoRequest($account_id);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Cakemail\Lib\Model\DeleteLogoResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Cakemail\Lib\Model\DeleteLogoResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Cakemail\Lib\Model\DeleteLogoResponse', []),
            ...
            $returnType = '\Cakemail\Lib\Model\DeleteLogoResponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Cakemail\Lib\Model\DeleteLogoResponse',
    ...
    /**
     * Operation deleteDefaultLogoAsync
     *
     * Delete the default logo
     *
     * @param  int $account_id (optional)
     ...
     */
    public function deleteDefaultLogoAsync($account_id = null)
    {
        return $this->deleteDefaultLogoAsyncWithHttpInfo($account_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation deleteDefaultLogoAsyncWithHttpInfo
     *
     * Delete the default logo
     *
     * @param  int $account_id (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteDefaultLogoAsyncWithHttpInfo($account_id = null)
    {
        $returnType = '\Cakemail\Lib\Model\DeleteLogoResponse';
        $request = $this->deleteDefaultLogoRequest($account_id);
    ...
    /**
     * Create request for operation 'deleteDefaultLogo'
     *
     * @param  int $account_id (optional)
     *
     * @throws \InvalidArgumentException
     ...
     */
    public function deleteDefaultLogoRequest($account_id = null)
    {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Cakemail\Lib\Model\UploadLogoResponse' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\Cakemail\Lib\Model\UploadLogoResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
