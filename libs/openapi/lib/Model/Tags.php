...
class Tags implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setTags($tags)
    {
        ...
        if ((count($tags) > 1024)) {
            throw new \InvalidArgumentException('invalid value for $tags when calling Tags., number of items must be less than or equal to 1024.');
        }
        if ((count($tags) < 1)) {
            throw new \InvalidArgumentException('invalid length for $tags when calling Tags., number of items must be greater than or equal to 1.');
        }
