...
class ContactApi
{
     ...
     */
    public function createContactRequest($list_id, $contact, $account_id = null, $send_double_opt_in = false)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function importContactsRequest($list_id, $import_contacts, $account_id = null)
    {
        // verify the required parameter 'list_id' is set
        if ($list_id === null || (is_array($list_id) && count($list_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function listContactsOfListRequest($list_id, $account_id = null, $page = 1, $per_page = 50, $with_count = false, $query = null, $fiql = null, $json = null, $sort = null, $filter = null)
    {
        // verify the required parameter 'list_id' is set
        if ($list_id === null || (is_array($list_id) && count($list_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function listContactsOfSegmentRequest($segment_id, $list_id, $account_id = null, $page = 1, $per_page = 50, $with_count = false, $query = null, $fiql = null, $json = null, $sort = null, $filter = null)
    {
