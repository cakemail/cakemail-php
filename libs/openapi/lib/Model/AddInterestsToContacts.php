...
/**
 * AddInterestsToContacts Class Doc Comment
 *
 * @category Class
 * @package  Cakemail\Lib
 * @author   OpenAPI Generator team
 ...
 */
class AddInterestsToContacts implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AddInterestsToContacts';
    ...
    public function setInterests($interests)
    {
        ...
        if ((count($interests) > 16)) {
            throw new \InvalidArgumentException('invalid value for $interests when calling AddInterestsToContacts., number of items must be less than or equal to 16.');
        }
    ...
    public function setContactIds($contact_ids)
    {
        ...
        if (!is_null($contact_ids) && (count($contact_ids) > 1024)) {
            throw new \InvalidArgumentException('invalid value for $contact_ids when calling AddInterestsToContacts., number of items must be less than or equal to 1024.');
        }
