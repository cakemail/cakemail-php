...
class CampaignBlueprintApi
{
     ...
     *                      string <b>$filter</b> Valid Terms:   - &#x60;tag&#x60;   - &#x60;name&#x60;   - &#x60;is_owner&#x60;   - &#x60;is_not_owner&#x60;  Valid Operators:   - &#x60;&#x3D;&#x3D;&#x60;  Query separator:   - &#x60;;&#x60; (optional)<br>
    ...
    public function list($params = [])
    {
        ...
        return new Response($this->openApiObj->listCampaignBlueprintsWithHttpInfo($allParams['page']['value'], $allParams['per_page']['value'], $allParams['with_count']['value'], $allParams['account_id']['value'], $allParams['filter']['value'], $allParams['sort']['value']));
    }
