...
class Address implements ModelInterface, ArrayAccess
{
    ...
    public function setAddress1($address1)
    {
        ...
        if ((mb_strlen($address1) < 1)) {
            throw new \InvalidArgumentException('invalid length for $address1 when calling Address., must be bigger than or equal to 1.');
        }
    ...
    public function setProvince($province)
    {
        ...
        if ((mb_strlen($province) < 1)) {
            throw new \InvalidArgumentException('invalid length for $province when calling Address., must be bigger than or equal to 1.');
        }
