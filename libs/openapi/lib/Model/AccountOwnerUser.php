...
class AccountOwnerUser implements ModelInterface, ArrayAccess
{
    ...
    public function setFirstName($first_name)
    {
        ...
        if ((mb_strlen($first_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $first_name when calling AccountOwnerUser., must be bigger than or equal to 1.');
        }
    ...
    public function setLastName($last_name)
    {
        ...
        if ((mb_strlen($last_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $last_name when calling AccountOwnerUser., must be bigger than or equal to 1.');
        }
    ...
    public function setTitle($title)
    {
        ...
        if (!is_null($title) && (mb_strlen($title) < 1)) {
            throw new \InvalidArgumentException('invalid length for $title when calling AccountOwnerUser., must be bigger than or equal to 1.');
        }
    ...
    public function setOfficePhone($office_phone)
    {
        ...
        if (!is_null($office_phone) && (mb_strlen($office_phone) < 1)) {
            throw new \InvalidArgumentException('invalid length for $office_phone when calling AccountOwnerUser., must be bigger than or equal to 1.');
        }
    ...
    public function setMobilePhone($mobile_phone)
    {
        ...
        if (!is_null($mobile_phone) && (mb_strlen($mobile_phone) < 10)) {
            throw new \InvalidArgumentException('invalid length for $mobile_phone when calling AccountOwnerUser., must be bigger than or equal to 10.');
        }
