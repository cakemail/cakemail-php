...
/**
 * FormRedirections Class Doc Comment
 *
 * @category Class
 * @package  Cakemail\Lib
 * @author   OpenAPI Generator team
 ...
 */
class FormRedirections implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FormRedirections';
     ...
     * Sets after_opt_in
     *
     * @param string|null $after_opt_in after_opt_in
     *
     * @return self
     */
    public function setAfterOptIn($after_opt_in)
    {
        if (!is_null($after_opt_in) && (mb_strlen($after_opt_in) > 2083)) {
            throw new \InvalidArgumentException('invalid length for $after_opt_in when calling FormRedirections., must be smaller than or equal to 2083.');
        }
        if (!is_null($after_opt_in) && (mb_strlen($after_opt_in) < 1)) {
            throw new \InvalidArgumentException('invalid length for $after_opt_in when calling FormRedirections., must be bigger than or equal to 1.');
        }
     ...
     *
     * @param string|null $after_double_opt_in after_double_opt_in
     *
     * @return self
     */
    public function setAfterDoubleOptIn($after_double_opt_in)
    {
        if (!is_null($after_double_opt_in) && (mb_strlen($after_double_opt_in) > 2083)) {
            throw new \InvalidArgumentException('invalid length for $after_double_opt_in when calling FormRedirections., must be smaller than or equal to 2083.');
        }
        if (!is_null($after_double_opt_in) && (mb_strlen($after_double_opt_in) < 1)) {
            throw new \InvalidArgumentException('invalid length for $after_double_opt_in when calling FormRedirections., must be bigger than or equal to 1.');
        }
     ...
     * Sets after_opt_out
     *
     * @param string|null $after_opt_out after_opt_out
     *
     * @return self
     */
    public function setAfterOptOut($after_opt_out)
    {
        if (!is_null($after_opt_out) && (mb_strlen($after_opt_out) > 2083)) {
            throw new \InvalidArgumentException('invalid length for $after_opt_out when calling FormRedirections., must be smaller than or equal to 2083.');
        }
        if (!is_null($after_opt_out) && (mb_strlen($after_opt_out) < 1)) {
            throw new \InvalidArgumentException('invalid length for $after_opt_out when calling FormRedirections., must be bigger than or equal to 1.');
        }
