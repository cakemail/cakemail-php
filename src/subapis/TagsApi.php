...
class TagsApi
{
     ...
     *
     * @param mixed[] $params
     *                      \Cakemail\Lib\Model\Tag <b>$tag</b> (required)<br>
    ...
    public function createTag($params)
    {
        ...
        return new Response($this->openApiObj->createTagWithHttpInfo($allParams['tag']['value'], $allParams['account_id']['value']));
    }
     ...
     * @param mixed[] $params
     *                      string <b>$tag</b> (required)<br>
     *                      \Cakemail\Lib\Model\Tag <b>$tag2</b> (required)<br>
     *                      int <b>$account_id</b> (optional)<br>
     *
     * @throws \Cakemail\Lib\ApiException on non-2xx response
     * @throws \InvalidArgumentException
    ...
    public function patchTag($params)
    {
        ...
        $allParams = [
                        'tag' => ['value' => null, 'isOptional' => false],
                        'tag2' => ['value' => null, 'isOptional' => false],
                        'account_id' => ['value' => null, 'isOptional' => true],
                    ];

        $allParams = $this->fillParams($params, $allParams);

        return new Response($this->openApiObj->patchTagWithHttpInfo($allParams['tag']['value'], $allParams['tag2']['value'], $allParams['account_id']['value']));
    }
