...
class PatchAccount implements ModelInterface, ArrayAccess
{
    ...
    public function setName($name)
    {
        ...
        if (!is_null($name) && (mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling PatchAccount., must be bigger than or equal to 1.');
        }
    ...
    public function setFax($fax)
    {
        ...
        if (!is_null($fax) && (mb_strlen($fax) < 10)) {
            throw new \InvalidArgumentException('invalid length for $fax when calling PatchAccount., must be bigger than or equal to 10.');
        }
    ...
    public function setPhone($phone)
    {
        ...
        if (!is_null($phone) && (mb_strlen($phone) < 10)) {
            throw new \InvalidArgumentException('invalid length for $phone when calling PatchAccount., must be bigger than or equal to 10.');
        }
