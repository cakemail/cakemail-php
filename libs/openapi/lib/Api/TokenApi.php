...
class TokenApi
{
     ...
     * @param  string $version version (optional, default to 'v1')
     ...
     */
    public function createToken($username, $version = 'v1', $grant_type = null, $password = null, $account_id = null, $scopes = 'user', $expiration_seconds = null)
    {
        list($response) = $this->createTokenWithHttpInfo($username, $version, $grant_type, $password, $account_id, $scopes, $expiration_seconds);
        return $response;
    }
     ...
     * @param  string $version (optional, default to 'v1')
     ...
     */
    public function createTokenWithHttpInfo($username, $version = 'v1', $grant_type = null, $password = null, $account_id = null, $scopes = 'user', $expiration_seconds = null)
    {
        $request = $this->createTokenRequest($username, $version, $grant_type, $password, $account_id, $scopes, $expiration_seconds);
     ...
     */
    public function createTokenAsync($username, $version = 'v1', $grant_type = null, $password = null, $account_id = null, $scopes = 'user', $expiration_seconds = null)
    {
        return $this->createTokenAsyncWithHttpInfo($username, $version, $grant_type, $password, $account_id, $scopes, $expiration_seconds)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createTokenAsyncWithHttpInfo($username, $version = 'v1', $grant_type = null, $password = null, $account_id = null, $scopes = 'user', $expiration_seconds = null)
    {
        $returnType = '\Cakemail\Lib\Model\TokenResponse';
        $request = $this->createTokenRequest($username, $version, $grant_type, $password, $account_id, $scopes, $expiration_seconds);
     ...
     */
    public function createTokenRequest($username, $version = 'v1', $grant_type = null, $password = null, $account_id = null, $scopes = 'user', $expiration_seconds = null)
    {
     ...
     * @return \Cakemail\Lib\Model\TokenResponse|\Cakemail\Lib\Model\HTTPBadRequestError|\Cakemail\Lib\Model\HTTPUnauthorizedError|\Cakemail\Lib\Model\HTTPForbiddenError|\Cakemail\Lib\Model\HTTPValidationError
     */
    public function refreshToken($refresh_token, $version = 'v1', $grant_type = null)
    {
        list($response) = $this->refreshTokenWithHttpInfo($refresh_token, $version, $grant_type);
        return $response;
    }
     ...
     * @return array of \Cakemail\Lib\Model\TokenResponse|\Cakemail\Lib\Model\HTTPBadRequestError|\Cakemail\Lib\Model\HTTPUnauthorizedError|\Cakemail\Lib\Model\HTTPForbiddenError|\Cakemail\Lib\Model\HTTPValidationError, HTTP status code, HTTP response headers (array of strings)
     */
    public function refreshTokenWithHttpInfo($refresh_token, $version = 'v1', $grant_type = null)
    {
        $request = $this->refreshTokenRequest($refresh_token, $version, $grant_type);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function refreshTokenAsync($refresh_token, $version = 'v1', $grant_type = null)
    {
        return $this->refreshTokenAsyncWithHttpInfo($refresh_token, $version, $grant_type)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function refreshTokenAsyncWithHttpInfo($refresh_token, $version = 'v1', $grant_type = null)
    {
        $returnType = '\Cakemail\Lib\Model\TokenResponse';
        $request = $this->refreshTokenRequest($refresh_token, $version, $grant_type);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function refreshTokenRequest($refresh_token, $version = 'v1', $grant_type = null)
    {
