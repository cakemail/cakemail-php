...
/**
 * ActionContent Class Doc Comment
 *
 * @category Class
 * @package  Cakemail\Lib
 * @author   OpenAPI Generator team
 ...
 */
class ActionContent implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ActionContent';
    ...
    public function setSubject($subject)
    {
        ...
        if (!is_null($subject) && (mb_strlen($subject) < 1)) {
            throw new \InvalidArgumentException('invalid length for $subject when calling ActionContent., must be bigger than or equal to 1.');
        }
    ...
    public function setHtml($html)
    {
        ...
        if (!is_null($html) && (mb_strlen($html) < 1)) {
            throw new \InvalidArgumentException('invalid length for $html when calling ActionContent., must be bigger than or equal to 1.');
        }
    ...
    public function setText($text)
    {
        ...
        if (!is_null($text) && (mb_strlen($text) < 1)) {
            throw new \InvalidArgumentException('invalid length for $text when calling ActionContent., must be bigger than or equal to 1.');
        }
