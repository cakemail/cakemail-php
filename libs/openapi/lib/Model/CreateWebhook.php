 ...
 */
class CreateWebhook implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateWebhook';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['rate_limit'] = $data['rate_limit'] ?? 100;
     ...
     * Gets event
     *
     * @return \Cakemail\Lib\Model\EventType
     */
     ...
     * Sets event
     *
     * @param \Cakemail\Lib\Model\EventType $event event
     *
     * @return self
     */
    ...
    public function setUrl($url)
    {
        if ((mb_strlen($url) > 2083)) {
            throw new \InvalidArgumentException('invalid length for $url when calling CreateWebhook., must be smaller than or equal to 2083.');
        }
        if ((mb_strlen($url) < 1)) {
            throw new \InvalidArgumentException('invalid length for $url when calling CreateWebhook., must be bigger than or equal to 1.');
        }
     ...
     *
     * @param RateLimitPeriod|null $rate_limit_period rate_limit_period
     *
     * @return self
     */
