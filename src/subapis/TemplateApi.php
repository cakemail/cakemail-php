...
class TemplateApi
{
     ...
     *                      string <b>$sort</b> Sort term and direction, using syntax &#x60;[-|+]term&#x60;.  Valid terms:   - &#x60;id&#x60;   - &#x60;updated_on&#x60;   - &#x60;name&#x60; (optional, default to 'id')<br>
     *
     * @throws \Cakemail\Lib\ApiException on non-2xx response
     * @throws \InvalidArgumentException
    ...
    public function list($params = [])
    {
        ...
        return new Response($this->openApiObj->listTemplatesWithHttpInfo($allParams['page']['value'], $allParams['per_page']['value'], $allParams['account_id']['value'], $allParams['with_count']['value'], $allParams['sort']['value']));
    }
