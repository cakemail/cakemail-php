...
/**
 * UntagMultipleContacts Class Doc Comment
 *
 * @category Class
 * @package  Cakemail\Lib
 * @author   OpenAPI Generator team
 ...
 */
class UntagMultipleContacts implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UntagMultipleContacts';
    ...
    public function setTags($tags)
    {
        ...
        if ((count($tags) > 1024)) {
            throw new \InvalidArgumentException('invalid value for $tags when calling UntagMultipleContacts., number of items must be less than or equal to 1024.');
        }
        if ((count($tags) < 1)) {
            throw new \InvalidArgumentException('invalid length for $tags when calling UntagMultipleContacts., number of items must be greater than or equal to 1.');
        }
    ...
    public function setContactIds($contact_ids)
    {
        ...
        if (!is_null($contact_ids) && (count($contact_ids) > 1024)) {
            throw new \InvalidArgumentException('invalid value for $contact_ids when calling UntagMultipleContacts., number of items must be less than or equal to 1024.');
        }
        if (!is_null($contact_ids) && (count($contact_ids) < 1)) {
            throw new \InvalidArgumentException('invalid length for $contact_ids when calling UntagMultipleContacts., number of items must be greater than or equal to 1.');
        }
    ...
    public function setQuery($query)
    {
        ...
        if (!is_null($query) && (mb_strlen($query) < 1)) {
            throw new \InvalidArgumentException('invalid length for $query when calling UntagMultipleContacts., must be bigger than or equal to 1.');
        }
