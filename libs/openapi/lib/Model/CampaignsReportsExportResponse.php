...
/**
 * CampaignsReportsExportResponse Class Doc Comment
 *
 * @category Class
 * @package  Cakemail\Lib
 * @author   OpenAPI Generator team
 ...
 */
class CampaignsReportsExportResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CampaignsReportsExportResponse';
    ...
    public function setProgress($progress)
    {
        ...
        if (!is_null($progress) && ($progress < 0)) {
            throw new \InvalidArgumentException('invalid value for $progress when calling CampaignsReportsExportResponse., must be bigger than or equal to 0.');
        }
