...
class ContactApi
{
     ...
     * @param  bool $send_double_opt_in send_double_opt_in (optional, default to false)
     *
     ...
     */
    public function createContact($list_id, $contact, $account_id = null, $send_double_opt_in = false)
    {
     ...
     * @param  bool $send_double_opt_in (optional, default to false)
     *
     * @throws \Cakemail\Lib\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     */
    public function createContactWithHttpInfo($list_id, $contact, $account_id = null, $send_double_opt_in = false)
    {
     ...
     */
    public function createContactAsync($list_id, $contact, $account_id = null, $send_double_opt_in = false)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createContactAsyncWithHttpInfo($list_id, $contact, $account_id = null, $send_double_opt_in = false)
    {
        $returnType = '\Cakemail\Lib\Model\CreateContactResponse';
        $request = $this->createContactRequest($list_id, $contact, $account_id, $send_double_opt_in);
     ...
     */
    protected function createContactRequest($list_id, $contact, $account_id = null, $send_double_opt_in = false)
    {
     ...
     */
    public function importContacts($list_id, $import_contacts, $account_id = null)
    {
        list($response) = $this->importContactsWithHttpInfo($list_id, $import_contacts, $account_id);
        return $response;
    }
     ...
     */
    public function importContactsWithHttpInfo($list_id, $import_contacts, $account_id = null)
    {
        $request = $this->importContactsRequest($list_id, $import_contacts, $account_id);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function importContactsAsync($list_id, $import_contacts, $account_id = null)
    {
        return $this->importContactsAsyncWithHttpInfo($list_id, $import_contacts, $account_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function importContactsAsyncWithHttpInfo($list_id, $import_contacts, $account_id = null)
    {
        $returnType = '\Cakemail\Lib\Model\ImportContactsResponse';
        $request = $this->importContactsRequest($list_id, $import_contacts, $account_id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function importContactsRequest($list_id, $import_contacts, $account_id = null)
    {
        // verify the required parameter 'list_id' is set
        if ($list_id === null || (is_array($list_id) && count($list_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     */
    public function listContactsOfList($list_id, $account_id = null, $page = 1, $per_page = 50, $with_count = false, $query = null, $fiql = null, $json = null, $sort = null, $filter = null)
    {
        list($response) = $this->listContactsOfListWithHttpInfo($list_id, $account_id, $page, $per_page, $with_count, $query, $fiql, $json, $sort, $filter);
        return $response;
    }
     ...
     */
    public function listContactsOfListWithHttpInfo($list_id, $account_id = null, $page = 1, $per_page = 50, $with_count = false, $query = null, $fiql = null, $json = null, $sort = null, $filter = null)
    {
        $request = $this->listContactsOfListRequest($list_id, $account_id, $page, $per_page, $with_count, $query, $fiql, $json, $sort, $filter);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listContactsOfListAsync($list_id, $account_id = null, $page = 1, $per_page = 50, $with_count = false, $query = null, $fiql = null, $json = null, $sort = null, $filter = null)
    {
        return $this->listContactsOfListAsyncWithHttpInfo($list_id, $account_id, $page, $per_page, $with_count, $query, $fiql, $json, $sort, $filter)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listContactsOfListAsyncWithHttpInfo($list_id, $account_id = null, $page = 1, $per_page = 50, $with_count = false, $query = null, $fiql = null, $json = null, $sort = null, $filter = null)
    {
        $returnType = '\Cakemail\Lib\Model\ContactsResponse';
        $request = $this->listContactsOfListRequest($list_id, $account_id, $page, $per_page, $with_count, $query, $fiql, $json, $sort, $filter);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function listContactsOfListRequest($list_id, $account_id = null, $page = 1, $per_page = 50, $with_count = false, $query = null, $fiql = null, $json = null, $sort = null, $filter = null)
    {
        // verify the required parameter 'list_id' is set
        if ($list_id === null || (is_array($list_id) && count($list_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \Cakemail\Lib\Model\ContactsResponse|\Cakemail\Lib\Model\HTTPBadRequestError|\Cakemail\Lib\Model\HTTPValidationError
     */
    public function listContactsOfSegment($segment_id, $list_id, $account_id = null, $page = 1, $per_page = 50, $with_count = false, $query = null, $fiql = null, $json = null, $sort = null, $filter = null)
    {
        list($response) = $this->listContactsOfSegmentWithHttpInfo($segment_id, $list_id, $account_id, $page, $per_page, $with_count, $query, $fiql, $json, $sort, $filter);
        return $response;
    }
     ...
     * @return array of \Cakemail\Lib\Model\ContactsResponse|\Cakemail\Lib\Model\HTTPBadRequestError|\Cakemail\Lib\Model\HTTPValidationError, HTTP status code, HTTP response headers (array of strings)
     */
    public function listContactsOfSegmentWithHttpInfo($segment_id, $list_id, $account_id = null, $page = 1, $per_page = 50, $with_count = false, $query = null, $fiql = null, $json = null, $sort = null, $filter = null)
    {
        $request = $this->listContactsOfSegmentRequest($segment_id, $list_id, $account_id, $page, $per_page, $with_count, $query, $fiql, $json, $sort, $filter);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listContactsOfSegmentAsync($segment_id, $list_id, $account_id = null, $page = 1, $per_page = 50, $with_count = false, $query = null, $fiql = null, $json = null, $sort = null, $filter = null)
    {
        return $this->listContactsOfSegmentAsyncWithHttpInfo($segment_id, $list_id, $account_id, $page, $per_page, $with_count, $query, $fiql, $json, $sort, $filter)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listContactsOfSegmentAsyncWithHttpInfo($segment_id, $list_id, $account_id = null, $page = 1, $per_page = 50, $with_count = false, $query = null, $fiql = null, $json = null, $sort = null, $filter = null)
    {
        $returnType = '\Cakemail\Lib\Model\ContactsResponse';
        $request = $this->listContactsOfSegmentRequest($segment_id, $list_id, $account_id, $page, $per_page, $with_count, $query, $fiql, $json, $sort, $filter);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function listContactsOfSegmentRequest($segment_id, $list_id, $account_id = null, $page = 1, $per_page = 50, $with_count = false, $query = null, $fiql = null, $json = null, $sort = null, $filter = null)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function patchContactRequest($list_id, $contact_id, $patch_contact, $account_id = null)
    {
        // verify the required parameter 'list_id' is set
        if ($list_id === null || (is_array($list_id) && count($list_id) === 0)) {
            throw new \InvalidArgumentException(
