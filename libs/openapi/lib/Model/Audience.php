...
class Audience implements ModelInterface, ArrayAccess
{
    ...
    public function setListId($list_id)
    {
        ...
        if (!is_null($list_id) && ($list_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $list_id when calling Audience., must be bigger than or equal to 1.');
        }
    ...
    public function setSegmentId($segment_id)
    {
        ...
        if (!is_null($segment_id) && ($segment_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $segment_id when calling Audience., must be bigger than or equal to 1.');
        }
