...
class ContactApi
{
     ...
     */
    public function createContact($list_id, $contact, $account_id = null)
    {
        list($response) = $this->createContactWithHttpInfo($list_id, $contact, $account_id);
        return $response;
    }
     ...
     */
    public function createContactWithHttpInfo($list_id, $contact, $account_id = null)
    {
        $request = $this->createContactRequest($list_id, $contact, $account_id);
     ...
     */
    public function createContactAsync($list_id, $contact, $account_id = null)
    {
        return $this->createContactAsyncWithHttpInfo($list_id, $contact, $account_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createContactAsyncWithHttpInfo($list_id, $contact, $account_id = null)
    {
        $returnType = '\Cakemail\Lib\Model\CreateContactResponse';
        $request = $this->createContactRequest($list_id, $contact, $account_id);
     ...
     */
    protected function createContactRequest($list_id, $contact, $account_id = null)
    {
