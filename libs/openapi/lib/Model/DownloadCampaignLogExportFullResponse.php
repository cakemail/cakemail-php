...
/**
 * DownloadCampaignLogExportFullResponse Class Doc Comment
 *
 * @category Class
 * @package  Cakemail\Lib
 * @author   OpenAPI Generator team
 ...
 */
class DownloadCampaignLogExportFullResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DownloadCampaignLogExportFullResponse';
    ...
    public function setUrl($url)
    {
        if ((mb_strlen($url) > 65536)) {
            throw new \InvalidArgumentException('invalid length for $url when calling DownloadCampaignLogExportFullResponse., must be smaller than or equal to 65536.');
        }
        if ((mb_strlen($url) < 1)) {
            throw new \InvalidArgumentException('invalid length for $url when calling DownloadCampaignLogExportFullResponse., must be bigger than or equal to 1.');
        }
