...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://api.cakemail.dev';
    ...
    {
        $report  = 'PHP SDK (Cakemail\Lib) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . PHP_VERSION . PHP_EOL;
        $report .= '    The version of the OpenAPI document: 1.12.26' . PHP_EOL;
