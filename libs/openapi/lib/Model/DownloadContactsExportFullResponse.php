...
/**
 * DownloadContactsExportFullResponse Class Doc Comment
 *
 * @category Class
 * @package  Cakemail\Lib
 * @author   OpenAPI Generator team
 ...
 */
class DownloadContactsExportFullResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DownloadContactsExportFullResponse';
    ...
    public function setUrl($url)
    {
        if ((mb_strlen($url) > 65536)) {
            throw new \InvalidArgumentException('invalid length for $url when calling DownloadContactsExportFullResponse., must be smaller than or equal to 65536.');
        }
        if ((mb_strlen($url) < 1)) {
            throw new \InvalidArgumentException('invalid length for $url when calling DownloadContactsExportFullResponse., must be bigger than or equal to 1.');
        }
