...
class ActionApi
{
     ...
     */
    public function createAction($workflow_id, $action, $account_id = null)
    {
        list($response) = $this->createActionWithHttpInfo($workflow_id, $action, $account_id);
        return $response;
    }
     ...
     */
    public function createActionWithHttpInfo($workflow_id, $action, $account_id = null)
    {
        $request = $this->createActionRequest($workflow_id, $action, $account_id);
     ...
     */
    public function createActionAsync($workflow_id, $action, $account_id = null)
    {
        return $this->createActionAsyncWithHttpInfo($workflow_id, $action, $account_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createActionAsyncWithHttpInfo($workflow_id, $action, $account_id = null)
    {
        $returnType = '\Cakemail\Lib\Model\CreateActionResponse';
        $request = $this->createActionRequest($workflow_id, $action, $account_id);
     ...
     */
    protected function createActionRequest($workflow_id, $action, $account_id = null)
    {
     ...
     */
    public function deleteAction($action_id, $workflow_id, $account_id = null)
    {
        list($response) = $this->deleteActionWithHttpInfo($action_id, $workflow_id, $account_id);
        return $response;
    }
     ...
     */
    public function deleteActionWithHttpInfo($action_id, $workflow_id, $account_id = null)
    {
        $request = $this->deleteActionRequest($action_id, $workflow_id, $account_id);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteActionAsync($action_id, $workflow_id, $account_id = null)
    {
        return $this->deleteActionAsyncWithHttpInfo($action_id, $workflow_id, $account_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteActionAsyncWithHttpInfo($action_id, $workflow_id, $account_id = null)
    {
        $returnType = '\Cakemail\Lib\Model\DeleteActionResponse';
        $request = $this->deleteActionRequest($action_id, $workflow_id, $account_id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function deleteActionRequest($action_id, $workflow_id, $account_id = null)
    {
     ...
     */
    public function getAction($workflow_id, $action_id, $account_id = null)
    {
        list($response) = $this->getActionWithHttpInfo($workflow_id, $action_id, $account_id);
        return $response;
    }
     ...
     */
    public function getActionWithHttpInfo($workflow_id, $action_id, $account_id = null)
    {
        $request = $this->getActionRequest($workflow_id, $action_id, $account_id);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getActionAsync($workflow_id, $action_id, $account_id = null)
    {
        return $this->getActionAsyncWithHttpInfo($workflow_id, $action_id, $account_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getActionAsyncWithHttpInfo($workflow_id, $action_id, $account_id = null)
    {
        $returnType = '\Cakemail\Lib\Model\GetActionResponse';
        $request = $this->getActionRequest($workflow_id, $action_id, $account_id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getActionRequest($workflow_id, $action_id, $account_id = null)
    {
        // verify the required parameter 'workflow_id' is set
        if ($workflow_id === null || (is_array($workflow_id) && count($workflow_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function listActionLinksRequest($action_id, $workflow_id, $account_id = null, $page = 1, $per_page = 50, $with_count = false)
    {
        // verify the required parameter 'action_id' is set
        if ($action_id === null || (is_array($action_id) && count($action_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function listActionsRequest($workflow_id, $page = 1, $per_page = 50, $with_count = false, $account_id = null, $sort = null)
    {
        // verify the required parameter 'workflow_id' is set
        if ($workflow_id === null || (is_array($workflow_id) && count($workflow_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     */
    public function patchAction($action_id, $workflow_id, $patch_action, $account_id = null)
    {
        list($response) = $this->patchActionWithHttpInfo($action_id, $workflow_id, $patch_action, $account_id);
        return $response;
    }
     ...
     */
    public function patchActionWithHttpInfo($action_id, $workflow_id, $patch_action, $account_id = null)
    {
        $request = $this->patchActionRequest($action_id, $workflow_id, $patch_action, $account_id);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function patchActionAsync($action_id, $workflow_id, $patch_action, $account_id = null)
    {
        return $this->patchActionAsyncWithHttpInfo($action_id, $workflow_id, $patch_action, $account_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function patchActionAsyncWithHttpInfo($action_id, $workflow_id, $patch_action, $account_id = null)
    {
        $returnType = '\Cakemail\Lib\Model\PatchActionResponse';
        $request = $this->patchActionRequest($action_id, $workflow_id, $patch_action, $account_id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function patchActionRequest($action_id, $workflow_id, $patch_action, $account_id = null)
    {
        // verify the required parameter 'action_id' is set
        if ($action_id === null || (is_array($action_id) && count($action_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @throws \Cakemail\Lib\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Cakemail\Lib\Model\RenderActionResponse|\Cakemail\Lib\Model\HTTPBadRequestError|\Cakemail\Lib\Model\HTTPValidationError
     */
    public function renderAction($workflow_id, $action_id, $account_id = null)
    {
        list($response) = $this->renderActionWithHttpInfo($workflow_id, $action_id, $account_id);
        return $response;
    }
     ...
     */
    public function renderActionWithHttpInfo($workflow_id, $action_id, $account_id = null)
    {
        $request = $this->renderActionRequest($workflow_id, $action_id, $account_id);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Cakemail\Lib\Model\RenderActionResponse' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Cakemail\Lib\Model\RenderActionResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\Cakemail\Lib\Model\RenderActionResponse';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Cakemail\Lib\Model\RenderActionResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function renderActionAsync($workflow_id, $action_id, $account_id = null)
    {
        return $this->renderActionAsyncWithHttpInfo($workflow_id, $action_id, $account_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function renderActionAsyncWithHttpInfo($workflow_id, $action_id, $account_id = null)
    {
        $returnType = '\Cakemail\Lib\Model\RenderActionResponse';
        $request = $this->renderActionRequest($workflow_id, $action_id, $account_id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function renderActionRequest($workflow_id, $action_id, $account_id = null)
    {
        // verify the required parameter 'workflow_id' is set
        if ($workflow_id === null || (is_array($workflow_id) && count($workflow_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     */
    public function sendTestAction($workflow_id, $action_id, $send_test_action, $account_id = null)
    {
        list($response) = $this->sendTestActionWithHttpInfo($workflow_id, $action_id, $send_test_action, $account_id);
        return $response;
    }
     ...
     */
    public function sendTestActionWithHttpInfo($workflow_id, $action_id, $send_test_action, $account_id = null)
    {
        $request = $this->sendTestActionRequest($workflow_id, $action_id, $send_test_action, $account_id);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function sendTestActionAsync($workflow_id, $action_id, $send_test_action, $account_id = null)
    {
        return $this->sendTestActionAsyncWithHttpInfo($workflow_id, $action_id, $send_test_action, $account_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function sendTestActionAsyncWithHttpInfo($workflow_id, $action_id, $send_test_action, $account_id = null)
    {
        $returnType = '\Cakemail\Lib\Model\SendTestActionResponse';
        $request = $this->sendTestActionRequest($workflow_id, $action_id, $send_test_action, $account_id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function sendTestActionRequest($workflow_id, $action_id, $send_test_action, $account_id = null)
    {
        // verify the required parameter 'workflow_id' is set
        if ($workflow_id === null || (is_array($workflow_id) && count($workflow_id) === 0)) {
            throw new \InvalidArgumentException(
