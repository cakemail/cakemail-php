 ...
 * @link     https://openapi-generator.tech
 */
class PatchSelfAccount implements ModelInterface, ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['fax']) && (mb_strlen($this->container['fax']) < 10)) {
            $invalidProperties[] = "invalid value for 'fax', the character length must be bigger than or equal to 10.";
        }
    ...
    public function setName($name)
    {
        ...
        if (!is_null($name) && (mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling PatchSelfAccount., must be bigger than or equal to 1.');
        }
     ...
     * Sets account_owner
     *
     * @param AccountOwner|null $account_owner account_owner
     *
     * @return $this
     */
    ...
    public function setFax($fax)
    {
        ...
        if (!is_null($fax) && (mb_strlen($fax) < 10)) {
            throw new \InvalidArgumentException('invalid length for $fax when calling PatchSelfAccount., must be bigger than or equal to 10.');
        }
    ...
    public function setPhone($phone)
    {
        ...
        if (!is_null($phone) && (mb_strlen($phone) < 10)) {
            throw new \InvalidArgumentException('invalid length for $phone when calling PatchSelfAccount., must be bigger than or equal to 10.');
        }
