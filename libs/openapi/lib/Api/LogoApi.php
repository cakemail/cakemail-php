...
class LogoApi
{
     ...
     */
    public function uploadDefaultLogo($brand_id, $upload_logo, $account_id = null)
    {
        list($response) = $this->uploadDefaultLogoWithHttpInfo($brand_id, $upload_logo, $account_id);
        return $response;
    }
     ...
     */
    public function uploadDefaultLogoWithHttpInfo($brand_id, $upload_logo, $account_id = null)
    {
        $request = $this->uploadDefaultLogoRequest($brand_id, $upload_logo, $account_id);
     ...
     */
    public function uploadDefaultLogoAsync($brand_id, $upload_logo, $account_id = null)
    {
        return $this->uploadDefaultLogoAsyncWithHttpInfo($brand_id, $upload_logo, $account_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function uploadDefaultLogoAsyncWithHttpInfo($brand_id, $upload_logo, $account_id = null)
    {
        $returnType = '\Cakemail\Lib\Model\UploadLogoResponse';
        $request = $this->uploadDefaultLogoRequest($brand_id, $upload_logo, $account_id);
     ...
     */
    public function uploadDefaultLogoRequest($brand_id, $upload_logo, $account_id = null)
    {
        // verify the required parameter 'brand_id' is set
        if ($brand_id === null || (is_array($brand_id) && count($brand_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $brand_id when calling uploadDefaultLogo'
            );
        }
        ...
        $resourcePath = '/brands/{brand_id}/logos/default';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
