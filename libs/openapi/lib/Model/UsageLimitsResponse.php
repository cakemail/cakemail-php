 ...
 * @link     https://openapi-generator.tech
 */
class UsageLimitsResponse implements ModelInterface, ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['per_campaign'] === null) {
            $invalidProperties[] = "'per_campaign' can't be null";
        }
        if ($this->container['per_month'] === null) {
            $invalidProperties[] = "'per_month' can't be null";
        }
        if ($this->container['maximum_contacts'] === null) {
            $invalidProperties[] = "'maximum_contacts' can't be null";
        }
