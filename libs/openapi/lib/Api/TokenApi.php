...
class TokenApi
{
     ...
     */
    public function createToken($username, $grant_type = null, $password = null, $account_id = null, $scopes = 'user')
    {
        list($response) = $this->createTokenWithHttpInfo($username, $grant_type, $password, $account_id, $scopes);
        return $response;
    }
     ...
     */
    public function createTokenAsync($username, $grant_type = null, $password = null, $account_id = null, $scopes = 'user')
    {
        return $this->createTokenAsyncWithHttpInfo($username, $grant_type, $password, $account_id, $scopes)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createTokenAsyncWithHttpInfo($username, $grant_type = null, $password = null, $account_id = null, $scopes = 'user')
    {
        $returnType = '\Cakemail\Lib\Model\TokenResponse';
        $request = $this->createTokenRequest($username, $grant_type, $password, $account_id, $scopes);
     ...
     */
    public function createTokenRequest($username, $grant_type = null, $password = null, $account_id = null, $scopes = 'user')
    {
