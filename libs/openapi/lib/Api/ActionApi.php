...
class ActionApi
{
     ...
     */
    public function createActionRequest($workflow_id, $action, $account_id = null)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function deleteActionRequest($action_id, $workflow_id, $account_id = null)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getActionRequest($workflow_id, $action_id, $account_id = null)
    {
        // verify the required parameter 'workflow_id' is set
        if ($workflow_id === null || (is_array($workflow_id) && count($workflow_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function patchActionRequest($action_id, $workflow_id, $patch_action, $account_id = null)
    {
        // verify the required parameter 'action_id' is set
        if ($action_id === null || (is_array($action_id) && count($action_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function renderActionRequest($workflow_id, $action_id, $account_id = null)
    {
        // verify the required parameter 'workflow_id' is set
        if ($workflow_id === null || (is_array($workflow_id) && count($workflow_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function sendTestActionRequest($workflow_id, $action_id, $send_test_action, $account_id = null)
    {
        // verify the required parameter 'workflow_id' is set
        if ($workflow_id === null || (is_array($workflow_id) && count($workflow_id) === 0)) {
            throw new \InvalidArgumentException(
