 ...
 */
class Tracking1 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'tracking_1';
    ...
    {
        $this->container['opens'] = $data['opens'] ?? true;
        $this->container['clicks_html'] = $data['clicks_html'] ?? true;
        $this->container['clicks_text'] = $data['clicks_text'] ?? true;
    ...
    public function setAdditionalParams($additional_params)
    {
        ...
        if (!is_null($additional_params) && (mb_strlen($additional_params) < 1)) {
            throw new \InvalidArgumentException('invalid length for $additional_params when calling Tracking1., must be bigger than or equal to 1.');
        }
