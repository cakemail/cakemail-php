 ...
 */
class AccountOwner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'account_owner';
    ...
    public function setMobilePhone($mobile_phone)
    {
        ...
        if (!is_null($mobile_phone) && (!preg_match("/[0-9]+/", $mobile_phone))) {
            throw new \InvalidArgumentException("invalid value for $mobile_phone when calling AccountOwner., must conform to the pattern /[0-9]+/.");
        }
    ...
    public function setPassword($password)
    {
        ...
        if (!is_null($password) && (mb_strlen($password) < 8)) {
            throw new \InvalidArgumentException('invalid length for $password when calling AccountOwner., must be bigger than or equal to 8.');
        }
