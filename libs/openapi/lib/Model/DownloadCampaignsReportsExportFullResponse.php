...
/**
 * DownloadCampaignsReportsExportFullResponse Class Doc Comment
 *
 * @category Class
 * @package  Cakemail\Lib
 * @author   OpenAPI Generator team
 ...
 */
class DownloadCampaignsReportsExportFullResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DownloadCampaignsReportsExportFullResponse';
    ...
    public function setUrl($url)
    {
        if ((mb_strlen($url) > 65536)) {
            throw new \InvalidArgumentException('invalid length for $url when calling DownloadCampaignsReportsExportFullResponse., must be smaller than or equal to 65536.');
        }
        if ((mb_strlen($url) < 1)) {
            throw new \InvalidArgumentException('invalid length for $url when calling DownloadCampaignsReportsExportFullResponse., must be bigger than or equal to 1.');
        }
