 ...
 */
class PatchForm implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PatchForm';
    ...
    protected static $openAPITypes = [
        'name' => 'string',
        'status' => 'string',
        'content' => '\Cakemail\Lib\Model\Content1',
        'redirections' => '\Cakemail\Lib\Model\Redirections',
        'list_id' => 'int',
        'language' => 'Languages',
        'double_opt_in' => 'bool'
    ];
    ...
    public function setName($name)
    {
        ...
        if (!is_null($name) && (mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling PatchForm., must be bigger than or equal to 1.');
        }
    ...
    public function setStatus($status)
    {
        ...
        if (!is_null($status) && (mb_strlen($status) < 1)) {
            throw new \InvalidArgumentException('invalid length for $status when calling PatchForm., must be bigger than or equal to 1.');
        }
     ...
     * Gets content
     *
     * @return \Cakemail\Lib\Model\Content1|null
     */
     ...
     * Sets content
     *
     * @param \Cakemail\Lib\Model\Content1|null $content content
     *
     * @return self
     */
     ...
     * Gets redirections
     *
     * @return \Cakemail\Lib\Model\Redirections|null
     */
     ...
     * Sets redirections
     *
     * @param \Cakemail\Lib\Model\Redirections|null $redirections redirections
     *
     * @return self
     */
    ...
    public function setListId($list_id)
    {
        ...
        if (!is_null($list_id) && ($list_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $list_id when calling PatchForm., must be bigger than or equal to 1.');
        }
