...
class TokenApi
{
     ...
     */
    public function createToken($username, $password, $grant_type = null, $account_id = null)
    {
     ...
     */
    public function createTokenWithHttpInfo($username, $password, $grant_type = null, $account_id = null)
    {
     ...
     */
    public function createTokenAsync($username, $password, $grant_type = null, $account_id = null)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createTokenAsyncWithHttpInfo($username, $password, $grant_type = null, $account_id = null)
    {
        $returnType = '\Cakemail\Lib\Model\TokenResponse';
        $request = $this->createTokenRequest($username, $password, $grant_type, $account_id);
     ...
     */
    protected function createTokenRequest($username, $password, $grant_type = null, $account_id = null)
    {
