...
class CampaignBlueprintApi
{
            ...
            switch($statusCode) {
                case 200:
                    if ('\Cakemail\Lib\Model\CampaignBlueprintResponse' === '\SplFileObject') {
                        ...
                        if ('\Cakemail\Lib\Model\CampaignBlueprintResponse' !== 'string') {
     ...
     */
    public function listCampaignBlueprints($page = 1, $per_page = 50, $with_count = false, $account_id = null, $filter = null, $sort = 'id')
    {
        list($response) = $this->listCampaignBlueprintsWithHttpInfo($page, $per_page, $with_count, $account_id, $filter, $sort);
        return $response;
    }
     ...
     */
    public function listCampaignBlueprintsWithHttpInfo($page = 1, $per_page = 50, $with_count = false, $account_id = null, $filter = null, $sort = 'id')
    {
        $request = $this->listCampaignBlueprintsRequest($page, $per_page, $with_count, $account_id, $filter, $sort);
            ...
            switch($statusCode) {
                case 200:
                    if ('\Cakemail\Lib\Model\CampaignBlueprintsResponse' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\Cakemail\Lib\Model\CampaignBlueprintsResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listCampaignBlueprintsAsync($page = 1, $per_page = 50, $with_count = false, $account_id = null, $filter = null, $sort = 'id')
    {
        return $this->listCampaignBlueprintsAsyncWithHttpInfo($page, $per_page, $with_count, $account_id, $filter, $sort)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listCampaignBlueprintsAsyncWithHttpInfo($page = 1, $per_page = 50, $with_count = false, $account_id = null, $filter = null, $sort = 'id')
    {
        $returnType = '\Cakemail\Lib\Model\CampaignBlueprintsResponse';
        $request = $this->listCampaignBlueprintsRequest($page, $per_page, $with_count, $account_id, $filter, $sort);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function listCampaignBlueprintsRequest($page = 1, $per_page = 50, $with_count = false, $account_id = null, $filter = null, $sort = 'id')
    {
