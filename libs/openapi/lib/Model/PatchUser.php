...
class PatchUser implements ModelInterface, ArrayAccess
{
    ...
    public function setTitle($title)
    {
        ...
        if (!is_null($title) && (mb_strlen($title) < 1)) {
            throw new \InvalidArgumentException('invalid length for $title when calling PatchUser., must be bigger than or equal to 1.');
        }
    ...
    public function setOfficePhone($office_phone)
    {
        ...
        if (!is_null($office_phone) && (mb_strlen($office_phone) < 1)) {
            throw new \InvalidArgumentException('invalid length for $office_phone when calling PatchUser., must be bigger than or equal to 1.');
        }
    ...
    public function setMobilePhone($mobile_phone)
    {
        ...
        if (!is_null($mobile_phone) && (mb_strlen($mobile_phone) < 10)) {
            throw new \InvalidArgumentException('invalid length for $mobile_phone when calling PatchUser., must be bigger than or equal to 10.');
        }
